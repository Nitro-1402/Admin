...
function CommentList(){
  ...
  useEffect(() => {
      const payroll = async () => {
          const url = 'https://nitroback.pythonanywhere.com/comments/comments/';
          const data = {
      ...
      <div style={{textAlign:'right'}}>
        <div style={{margin:'60px 100px'}}>
          <div style={{margin:'30px',display:'flex',flexDirection:'row',justifyContent:'space-between'}}>
            ...
            <span style={{textAlign:'right', direction:'rtl'}}> نظرات </span>
        ...
        {items.map(item=>(
          ...
          >
            ...
            <span style={{textAlign:'right', direction:'rtl', width:'250px'}}>{item.message}</span>
